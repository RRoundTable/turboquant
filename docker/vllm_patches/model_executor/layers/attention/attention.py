...
def unified_attention_with_output(
    ...
    # Post-forward hook: enables backends to launch async operations
    # (e.g., KV cache quantization) that overlap with the output
    # projection and MLP compute of the current layer.
    if hasattr(self.impl, 'post_forward'):
        self.impl.post_forward(
            self, key, value, kv_cache, attn_metadata)
